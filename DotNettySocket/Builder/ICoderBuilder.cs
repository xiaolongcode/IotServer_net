...
namespace Coldairarrow.DotNettySocket
{
    ...
    public interface ICoderBuilder<TBuilder>
    {
        ...
        /// 超时时间
        /// </summary>
        /// <param name="readTime">读超时时间 设置为0，表示不启用</param>
        /// <param name="writeTime">写超时时间 设置为0，表示不启用</param>
        /// <param name="allTime">全部超时时间 设置为0，表示不启用</param>
        /// <returns></returns>
        TBuilder SetTimeout(int readTime , int writeTime , int allTime );
    }
}
