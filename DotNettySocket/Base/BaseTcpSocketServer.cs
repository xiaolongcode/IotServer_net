...
namespace Coldairarrow.DotNettySocket
{
        ...
        where TSocketServer : class, IBaseTcpSocketServer<TConnection>
    {
        ...
        ConcurrentDictionary<string, string> _nameMapKey { get; }
       = new ConcurrentDictionary<string, string>();
        ...
        protected void AddConnection(TConnection theConnection)
        {
            ...
            _nameMapKey[theConnection.ConnectionKey] = theConnection.ConnectionId;
        }
        ...
        public TConnection GetConnectionByKey(string connectionKey)
        {
            return _idMapConnections[_nameMapKey[connectionKey]];
        }
        ...
        {
            return _nameMapKey.Keys.ToList();
        }
        ...
        public void RemoveConnection(TConnection theConnection)
        {
            ...
            _nameMapKey.TryRemove(theConnection.ConnectionKey, out _);
        }
        ...
        public void SetConnectionKey(TConnection theConnection, string oldConnectionKey, string newConnectionKey)
        {
            _nameMapKey.TryRemove(oldConnectionKey, out _);
            _nameMapKey[newConnectionKey] = theConnection.ConnectionId;
        }
        ...
        public abstract void UserEventTriggered(IChannelHandlerContext ctx, object msg);
        #endregion
    }
}