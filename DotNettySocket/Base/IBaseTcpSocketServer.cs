...
namespace Coldairarrow.DotNettySocket
{
        ...
        where SocketConnection : IBaseSocketConnection
    {
        ...
        /// </summary>
        /// <param name="theConnection">连接</param>
        /// <param name="oldConnectionKey">原连接Key</param>
        /// <param name="newConnectionKey">新连接Key</param>
        void SetConnectionKey(SocketConnection theConnection, string oldConnectionKey, string newConnectionKey);
        ...
        /// <returns></returns>
        SocketConnection GetConnectionByKey(string connectionKey);
        ...
        /// </summary>
        /// <returns></returns>
        List<string> GetAllConnectionKeys();
